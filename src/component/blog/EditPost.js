        ...
        <div className="container">
            <div className="row">
                <div className="col-8 offset-2">
                    ...
                    <div className="form-group">
                        <button className="btn btn-primary float-right btn-success" onClick={updatePost}>Submit</button>
                    </div>                    
                </div>
            </div>
        </div>
...
//     let navigate = useNavigate();
//     useEffect(()=>{
//         axios.get('https://medicalstore.mashupstack.com/api/medicine'+postId).then(response=>{
//             setTitle(response.data.title);
//             setContent(response.data.content);
//         })
//     },[postId]);
//     function updatePost(){
//         axios.post('https://medicalstore.mashupstack.com/api/medicine/1'+postId,{
//             title: title,
//             content: content
//         }).then(response=>{
//             alert(response.data.message)
